...
_LOCK_PATH = Path(tempfile.gettempdir()) / "nodexo-bittensor-codec-migration.lock"
_CYSCALE_VERSION = "0.5.0"
...
def ensure_bittensor_codec_compatibility() -> None:
    ...
    with _LOCK_PATH.open("a+") as lock_file:
        ...
        print("Nodexo: migrating Bittensor codec runtime...", file=sys.stderr)
        _run_pip(
            [
                "uninstall",
                "-y",
