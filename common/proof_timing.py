...
def _builtin_timing_models() -> dict[str, GpuTimingModel]:
    ...
    measured_and_reviewed = {
        ...
        "NVIDIA GeForce RTX 5090": GpuTimingModel(
            base1=1.5, base2=3.5, wall_grace=8.0, receipt_spread_grace=5.0,
            calibrated=False,
            provenance="extrapolated (~900 TOPS, N=18432, 32GB) - recalibrate before mainnet",
        ),
        "NVIDIA H100 80GB HBM3": GpuTimingModel(
            ...
            calibrated=True,
            calibrated_gpu_counts=(1, 2),
            provenance="production calibrated fit 2026-06-16 from validator DB p99/mean+2sd free samples (n=21, counts=2)",
        ),
        "NVIDIA A100-SXM4-80GB": GpuTimingModel(
            ...
            provenance="production calibrated fit 2026-06-16 from validator DB p99/mean+2sd free samples (n=42, counts=1,4)",
        ),
